package com.sinothk.view.image.crop.demo;
...
public class ImageCropDemoMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_crop_demo_main);
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            try {
                ...
                CropImageMainActivity.start(ImageCropDemoMainActivity.this, outfile1.getPath(), requestCode, index);//
            }catch (Exception r){
